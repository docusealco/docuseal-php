...
class SubmissionsApi
{
     ...
     *
     * @param  int $template_id The unique identifier of the document template. Allows to receive only submissions for a specific template. (optional)
     * @param  string $q Filter submissions based on submitters name, email or phone partial match. (optional)
     * @param  string $external_id Filter submissions by the given &#x60;external_id&#x60; value. (optional)
     ...
     * @param  int $before The unique identifier of the submission to end the list with. Allows to receive only submissions with id less than the specified value. (optional)
     * @param  int $after The unique identifier of the submission to start the list from. Allows to receive only submissions with id greater than the specified value. (optional)
     ...
     */
    public function getSubmissions($template_id = null, $q = null, $external_id = null, $template_folder = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getSubmissions'][0])
    {
        list($response) = $this->getSubmissionsWithHttpInfo($template_id, $q, $external_id, $template_folder, $limit, $before, $after, $contentType);
        return $response;
    }
     ...
     */
    public function getSubmissionsWithHttpInfo($template_id = null, $q = null, $external_id = null, $template_folder = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getSubmissions'][0])
    {
        $request = $this->getSubmissionsRequest($template_id, $q, $external_id, $template_folder, $limit, $before, $after, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubmissionsAsync($template_id = null, $q = null, $external_id = null, $template_folder = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getSubmissions'][0])
    {
        return $this->getSubmissionsAsyncWithHttpInfo($template_id, $q, $external_id, $template_folder, $limit, $before, $after, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubmissionsAsyncWithHttpInfo($template_id = null, $q = null, $external_id = null, $template_folder = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getSubmissions'][0])
    {
        $returnType = '\Docuseal\Model\GetSubmissions200Response';
        $request = $this->getSubmissionsRequest($template_id, $q, $external_id, $template_folder, $limit, $before, $after, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSubmissionsRequest($template_id = null, $q = null, $external_id = null, $template_folder = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getSubmissions'][0])
    {
