...
class TemplatesApi
{
     ...
     * @return \Docuseal\Model\AddDocumentToTemplate200Response
     */
     ...
     * @throws \Docuseal\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Docuseal\Model\AddDocumentToTemplate200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function addDocumentToTemplateWithHttpInfo($id, $add_document_to_template_request, string $contentType = self::contentTypes['addDocumentToTemplate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Docuseal\Model\AddDocumentToTemplate200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Docuseal\Model\AddDocumentToTemplate200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Docuseal\Model\AddDocumentToTemplate200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Docuseal\Model\AddDocumentToTemplate200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docuseal\Model\AddDocumentToTemplate200Response',
     ...
     * @throws \Docuseal\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Docuseal\Model\CloneTemplate200Response
     */
     ...
     * @throws \Docuseal\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Docuseal\Model\CloneTemplate200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function cloneTemplateWithHttpInfo($id, $clone_template_request, string $contentType = self::contentTypes['cloneTemplate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Docuseal\Model\CloneTemplate200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Docuseal\Model\CloneTemplate200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Docuseal\Model\CloneTemplate200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Docuseal\Model\CloneTemplate200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docuseal\Model\CloneTemplate200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $external_id The unique applications-specific identifier provided for the template via API or Embedded template form builder. Allows to receive only templates with your specified external id. (optional)
     ...
     * @param  int $before The unique identifier of the template to end the list with. Allows to receive only templates with id less than the specified value. (optional)
     * @param  int $after The unique identifier of the template to start the list from. Allows to receive only templates with id greater than the specified value. (optional)
     ...
     */
    public function getTemplates($q = null, $external_id = null, $folder = null, $archived = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getTemplates'][0])
    {
        list($response) = $this->getTemplatesWithHttpInfo($q, $external_id, $folder, $archived, $limit, $before, $after, $contentType);
        return $response;
    }
     ...
     */
    public function getTemplatesWithHttpInfo($q = null, $external_id = null, $folder = null, $archived = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getTemplates'][0])
    {
        $request = $this->getTemplatesRequest($q, $external_id, $folder, $archived, $limit, $before, $after, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTemplatesAsync($q = null, $external_id = null, $folder = null, $archived = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getTemplates'][0])
    {
        return $this->getTemplatesAsyncWithHttpInfo($q, $external_id, $folder, $archived, $limit, $before, $after, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTemplatesAsyncWithHttpInfo($q = null, $external_id = null, $folder = null, $archived = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getTemplates'][0])
    {
        $returnType = '\Docuseal\Model\GetTemplates200Response';
        $request = $this->getTemplatesRequest($q, $external_id, $folder, $archived, $limit, $before, $after, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTemplatesRequest($q = null, $external_id = null, $folder = null, $archived = null, $limit = null, $before = null, $after = null, string $contentType = self::contentTypes['getTemplates'][0])
    {
