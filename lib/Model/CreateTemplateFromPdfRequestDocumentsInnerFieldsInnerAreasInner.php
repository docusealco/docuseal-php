...
/**
 * CreateTemplateFromPdfRequestDocumentsInnerFieldsInnerAreasInner Class Doc Comment
 *
 * @category Class
 * @package  Docuseal
 * @author   OpenAPI Generator team
 ...
 */
class CreateTemplateFromPdfRequestDocumentsInnerFieldsInnerAreasInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createTemplateFromPdf_request_documents_inner_fields_inner_areas_inner';
    ...
    */
     ...
     * Sets page
     *
     * @param int $page Page number of the field area. Starts from 1.
     *
     * @return self
     */
