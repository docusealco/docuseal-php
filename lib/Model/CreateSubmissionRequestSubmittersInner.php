...
/**
 * CreateSubmissionRequestSubmittersInner Class Doc Comment
 *
 * @category Class
 * @package  Docuseal
 * @author   OpenAPI Generator team
 ...
 */
class CreateSubmissionRequestSubmittersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSubmission_request_submitters_inner';
    ...
    */
     ...
     * Sets role
     *
     * @param string|null $role The role name or title of the submitter.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object|null $metadata An object with pre-filled values for the submission. Use field names for keys of the object. For more configurations see `fields` param.
     *
     * @return self
     */
     ...
     *
     * @param string|null $completed_redirect_url Submitter specific URL to redirect to after the submission completion.
     *
     * @return self
     */
