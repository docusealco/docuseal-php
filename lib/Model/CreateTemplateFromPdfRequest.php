...
/**
 * CreateTemplateFromPdfRequest Class Doc Comment
 *
 * @category Class
 * @package  Docuseal
 * @author   OpenAPI Generator team
 ...
 */
class CreateTemplateFromPdfRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createTemplateFromPdf_request';
    ...
    protected static $openAPITypes = [
        ...
        'folder_name' => 'string',
        'external_id' => 'string',
        'documents' => '\Docuseal\Model\CreateTemplateFromPdfRequestDocumentsInner[]'
    ];
    ...
    */
     ...
     * Sets external_id
     *
     * @param string|null $external_id Your application-specific unique string key to identify this template within your app. Existing template with specified `external_id` will be updated with a new PDF.
     *
     * @return self
     */
     ...
     * Gets documents
     *
     * @return \Docuseal\Model\CreateTemplateFromPdfRequestDocumentsInner[]
     */
     ...
     * Sets documents
     *
     * @param \Docuseal\Model\CreateTemplateFromPdfRequestDocumentsInner[] $documents documents
     *
     * @return self
     */
