...
/**
 * GetSubmissions200ResponseDataInnerSubmittersInner Class Doc Comment
 *
 * @category Class
 * @package  Docuseal
 * @author   OpenAPI Generator team
 ...
 */
class GetSubmissions200ResponseDataInnerSubmittersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getSubmissions_200_response_data_inner_submitters_inner';
    ...
    */
     ...
     * Sets submission_id
     *
     * @param int|null $submission_id Submission ID number.
     *
     * @return self
     */
     ...
     * Sets declined_at
     *
     * @param string|null $declined_at The date and time when the submitter declined to complete the signing form.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of signing request for the submitter.
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string|null $role The role of the submitter.
     *
     * @return self
     */
     ...
     * Sets preferences
     *
     * @param object|null $preferences Object with submitter preferences.
     *
     * @return self
     */
