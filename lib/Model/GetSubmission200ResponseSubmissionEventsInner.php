...
/**
 * GetSubmission200ResponseSubmissionEventsInner Class Doc Comment
 *
 * @category Class
 * @package  Docuseal
 * @author   OpenAPI Generator team
 ...
 */
class GetSubmission200ResponseSubmissionEventsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getSubmission_200_response_submission_events_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Submission event unique ID number.
     *
     * @return self
     */
