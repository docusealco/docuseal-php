...
/**
 * CloneTemplateRequest Class Doc Comment
 *
 * @category Class
 * @package  Docuseal
 * @author   OpenAPI Generator team
 ...
 */
class CloneTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cloneTemplate_request';
    ...
    */
     ...
     * Sets folder_name
     *
     * @param string|null $folder_name The folder's name to which the template should be cloned.
     *
     * @return self
     */
