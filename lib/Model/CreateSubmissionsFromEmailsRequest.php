...
/**
 * CreateSubmissionsFromEmailsRequest Class Doc Comment
 *
 * @category Class
 * @package  Docuseal
 * @author   OpenAPI Generator team
 ...
 */
class CreateSubmissionsFromEmailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSubmissionsFromEmails_request';
    ...
    */
     ...
     * Sets emails
     *
     * @param string $emails A comma-separated list of email addresses to send the submission to.
     *
     * @return self
     */
