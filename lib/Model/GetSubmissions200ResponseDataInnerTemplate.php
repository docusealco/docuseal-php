...
/**
 * GetSubmissions200ResponseDataInnerTemplate Class Doc Comment
 *
 * @category Class
 * @package  Docuseal
 * @author   OpenAPI Generator team
 ...
 */
class GetSubmissions200ResponseDataInnerTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getSubmissions_200_response_data_inner_template';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the submission template.
     *
     * @return self
     */
     ...
     * Sets folder_name
     *
     * @param string|null $folder_name Folder name where the template is located.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The date and time when the submission template was created.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at The date and time when the submission template was last updated.
     *
     * @return self
     */
